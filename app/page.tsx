...
export default function Home() {
  ...
  return (
    <main className="mx-auto flex h-screen max-h-[-webkit-fill-available] w-full max-w-screen-lg flex-col justify-between overflow-hidden">
      ...
      {messages.length === 0 && content === '' && systemInstruction === '' && !systemInstructionEditMode ? (
        ...
        <div className="w-full max-w-screen-lg flex-1 overflow-y-auto scroll-smooth">
      ...
      <div className="max-w-screen-lg bg-background px-4 pb-8 pt-2 max-md:pb-4 max-sm:p-2 max-sm:pb-3">
